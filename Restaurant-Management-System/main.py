...
class RestaurantSystem():
    ...
    def initUI(self):
        ...
        self.name_label = Label(self.root, text="---By Robin Singh", fg="#900C3F", font=('arial', 14, 'bold'))
...
# ========================= Calculations of Cost of Items ===========================
    ...
    def CostofItems(self):
        ...
        self.SubTotalofITEMS = 'Rs.' + " " + str(float('%0.2f' % (self.PriceofFood + self.PriceofCakesandDrinks + 0.15)))
        self.SubTotal.set(self.SubTotalofITEMS)

        self.Tax = 'Rs.' + " " + str(float('%0.2f' % ((self.PriceofFood + self.PriceofCakesandDrinks + 0.15)*5)))
        self.PaidTax.set(self.Tax)
        self.TT = ((self.PriceofFood + self.PriceofCakesandDrinks + 0.15)*5)
        self.TC = 'Rs.' + " " + str(float('%0.2f' % ((self.PriceofFood + self.PriceofCakesandDrinks + 0.15) + self.TT)))
        print(self.TC)
    ...
    def Receipt(self):
        ...
        self.txtReceipt.insert(END, 'Cost of Cakes and Drinks: \t\t\t\t' + self.CostofCakesandDrinks.get() + "\nSub Total: \t\t\t\t" + self.SubTotal.get() + "\n")
